...
var TEMP_VAR_AUTOGEN126__RANDOM =  coreServer.stop();
...
var TIMING_TEMP_VAR_AUTOGEN126__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN126__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/cypress-ntlm-auth/test/manual/https.proxy.duration.manualTest.ts& [70, 4; 70, 28]& TEMP_VAR_AUTOGEN126__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN126__RANDOM));
...
var TEMP_VAR_AUTOGEN257__RANDOM =  coreServer.stop();
...
var TIMING_TEMP_VAR_AUTOGEN257__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN257__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/cypress-ntlm-auth/test/manual/https.proxy.duration.manualTest.ts& [338, 4; 338, 28]& TEMP_VAR_AUTOGEN257__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN257__RANDOM));
