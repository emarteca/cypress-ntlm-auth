...
var TEMP_VAR_AUTOGEN125__RANDOM =  coreServer.stop();
...
var TIMING_TEMP_VAR_AUTOGEN125__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN125__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/cypress-ntlm-auth/test/manual/http.proxy.duration.manualTest.ts& [70, 4; 70, 28]& TEMP_VAR_AUTOGEN125__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN125__RANDOM));
...
var TEMP_VAR_AUTOGEN253__RANDOM =  coreServer.stop();
...
var TIMING_TEMP_VAR_AUTOGEN253__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN253__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/cypress-ntlm-auth/test/manual/http.proxy.duration.manualTest.ts& [335, 4; 335, 28]& TEMP_VAR_AUTOGEN253__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN253__RANDOM));
