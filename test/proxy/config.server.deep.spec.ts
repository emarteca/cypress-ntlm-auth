...
var TEMP_VAR_AUTOGEN9__RANDOM =  configServer.start();
...
var TIMING_TEMP_VAR_AUTOGEN9__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN9__RANDOM = await  TEMP_VAR_AUTOGEN9__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/cypress-ntlm-auth/test/proxy/config.server.deep.spec.ts& [32, 4; 32, 46]& TEMP_VAR_AUTOGEN9__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN9__RANDOM));
 configApiUrl =   AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN9__RANDOM
