...
var TEMP_VAR_AUTOGEN40__RANDOM =  ntlmProxyServer.start();
...
var TIMING_TEMP_VAR_AUTOGEN40__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN40__RANDOM
...
var TEMP_VAR_AUTOGEN94__RANDOM =  ntlmProxyServer.start();
...
var TIMING_TEMP_VAR_AUTOGEN94__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN94__RANDOM
...
var TEMP_VAR_AUTOGEN141__RANDOM =  ntlmProxyServer.start();
...
var TIMING_TEMP_VAR_AUTOGEN141__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN141__RANDOM
...
var TEMP_VAR_AUTOGEN155__RANDOM =  ntlmProxyServer.start();
...
var TIMING_TEMP_VAR_AUTOGEN155__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN155__RANDOM
