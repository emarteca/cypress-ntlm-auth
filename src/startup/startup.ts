...
var TEMP_VAR_AUTOGEN182__RANDOM =  this._proxyMain.stop();

this._debug.log("Stopping ntlm-proxy...");
      

var TIMING_TEMP_VAR_AUTOGEN182__RANDOM = perf_hooks.performance.now();
 await  TEMP_VAR_AUTOGEN182__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/cypress-ntlm-auth/src/startup/startup.ts& [155, 6; 155, 35]& TEMP_VAR_AUTOGEN182__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN182__RANDOM));
